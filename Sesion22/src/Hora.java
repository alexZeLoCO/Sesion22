...
public class Hora {
	...
	/**
	 * Introdce hora y minutos, segundos default.
	 * @param a Hora
	 * @param b Minuto
	 */
	public Hora (int a, int b) {
		this(a,b,0);
	}
	/**
	 * Introduce Hora, minutos y segundos default.
	 * @param a Hora
	 */
	public Hora (int a) {
		this(a,0,0);
	...
	/**
	 * Copia horario completo.
	 * @param a Horario completo.
	 */
	public Hora (Hora a) {
		this(a.getHoras(),a.getMinutos(),a.getSegundos());
	}
